...
import com.appdev.vvish.service.stitching.FileUtils;
import com.appdev.vvish.service.stitching.Utils;

@Service
public class ImageStitchingService {
	public String generateImageVideo(List<String> mediaFiles) throws Exception {
...
//		System.out.println("You can find the output file here"+Utils.Finalize(Utils.concatenateM(mp4Videos )));;
		...
		String concatenated = Utils.concatenateM(mp4Videos);
